...
//     TL.fromTo(overlay, 2, { skewX: 30, scale: 1.5 }, { skewX: 0, xPercent: 100, transformOrigin: "0 % 100 %", ease: Power4.easeOut })
//         .from(projetInfo, 1, { skewY: 0, transformOrigin: "bottom left" }, "-*1.5")
//         .from(smallTitle, 0.3, { autoAlpha: 0, y: 30, ease: Power4.easeOut }, ".=0.8")
// })

// TweenMax.from({ y: 1200, ease: Power4.easeOut }).from(imag, 2, { scale: 1.6, ease: Power4.easeOut }, .2)
