        ...
        <div>
            ...
            <section className="text-one">
                ...
                <p>Vous avez besoin de voyager pendant que le Coronavirus se propage ? Comment l'avion d'affaires répond à la demande croissante de vols en jet privé pendant le COVID-19 ?
                    ...
                    Pour faire face à cette baisse des vols commerciaux en Europe, AEROAFFAIRES vous propose des solutions adaptées en jet privé pour répondre à vos besoins de déplacements urgents et éviter autant que possible d'être en contact avec des personnes susceptibles d'être porteuses du virus.

                    L'équipe d'AEROAFFAIRES se tient informée de l'évolution du COVID-19 et des actualités produites dans le monde, notamment de l'EASA (European Aviation Safety Agency) :
                    ...
                    AEROAFFAIRES a pour mission de vous aider à trouver et à louer un avion privé disponible qui répond à vos besoins.
...
<hr />
            <section className="contact">
                ...
                <p> Un interlocuteur disponible 24 / 24 7 / 7</p >
